export const en = {
  ...
  connections: {
    ...
    advanced: "Advanced (session token, proxy, TLS)",
    sessionToken: "Session Token (STS)",
    proxyUrl: "Proxy URL",
    skipTlsVerify: "Skip TLS verification",
    skipTlsVerifyHint: "Trust any certificate — use only for trusted self-hosted endpoints.",
    caCert: "Custom CA certificate (PEM)",
  ...
  storage: {
    ...
    copied: "Copied to clipboard",
    bookmarks: "Bookmarks",
    bookmarkAdd: "Bookmark this folder",
    bookmarkRemove: "Remove bookmark",
    bookmarkAdded: "Bookmarked",
    bookmarkEmpty: "No bookmarks yet. Star a folder to keep it one click away.",
    ...
    preview: "Preview",
    tags: "Tags",
    objectSettings: "Metadata & permissions",
    versions: "Versions",
  ...
  settings: {
    ...
    partConcurrency: "Parallel parts per transfer",
    partConcurrencyHint: "How many parts of one file upload/download at once.",
    concurrency: "Default concurrency",
    autoConsume: "Auto-run queue by default",
    uploadStorageClass: "Upload storage class",
    uploadStorageClassHint: "Storage class applied to newly uploaded objects.",
    uploadEncryption: "Upload encryption",
    uploadKmsKey: "KMS key ID",
  ...
  objectSettings: {
    ...
    metadataHint: "Saving rewrites the object in place (copy with replaced metadata).",
    ...
    restoreStarted: "Restore requested",
  },
  tags: {
    batchTitle: "Tags for {{count}} objects",
    batchHint: "The tag set below replaces the tags on every selected object.",
    batchSaved: "Tagged {{count}} object(s)",
    title: "Object Tags",
    key: "Key",
    value: "Value",
    add: "Add tag",
