...
export const ContextMenu = Primitive;
export const ContextMenuTrigger = Primitive.Trigger;

export const ContextMenuContent: Component<ComponentProps<"div">> = (props) => {
  const [local, rest] = splitProps(props, ["class"]);
  return (
    <Primitive.Portal>
      <Primitive.Content
        class={cn(
          "z-50 min-w-[12rem] overflow-hidden rounded-md border bg-popover p-1 text-popover-foreground shadow-md animate-content-show",
          local.class
        )}
        {...rest}
      />
...
export const ContextMenuSeparator: Component<ComponentProps<"div">> = (props) => {
  const [local, rest] = splitProps(props, ["class"]);
